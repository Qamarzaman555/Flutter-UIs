...
// Shadow
  ...
  static TextStyle xssSemiBoldStyle = TextStyle(
      color: primaryTextColor, fontSize: 10, fontWeight: FontWeight.w600);
...
// dark Theme
  ...
  static ThemeData _defaultTheme() {
    return ThemeData(
      ...
      textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
            foregroundColor:
                MaterialStateProperty.all<Color>(CHIStyles.primaryColor),
  ...
  static ThemeData get ninjaTheme => _defaultTheme();
}
